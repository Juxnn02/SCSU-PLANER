...
Open TEST_improved.html in any modern web browser.

Load a Track: Click "Load" on a curated track to populate your itinerary instantly.

Build Your Own:

Click on filter chips (e.g., "STEM," "Tour") to see matching sessions.

Click the "+ Add" button on any session.

The app will warn you if the new session conflicts with one already in your plan.
